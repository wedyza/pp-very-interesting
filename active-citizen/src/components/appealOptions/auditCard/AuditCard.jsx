...
function AuditCard ({appeal}) {
    ...
    const { textClass } = appeal.status_code && statusConfig[appeal.status_code.title] || {};
        ...
        <div className='history__appeal-card history__audit-card'>
            ...
            <div className="appeal-card__info">
                <div className="appeal-card__info_main audit-card__info_main">
                    <div className='appeal-card__title audit-card__title'><span>{appeal.title}</span></div>
                ...
                <div className='appeal-card__status'>
                    ...
                    <span className={`appeal-card__status_value ${textClass}`}>{appeal.status_code ? appeal.status_code.title : ''}</span>
                </div>
